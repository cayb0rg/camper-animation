...
.fromTo(slider, 1.3, {x: "0%"}, {x: "102%", ease: Power2.easeOut}, "-=0.5") // background
.fromTo(logo, 1.2, {x: 30, opacity: 0}, {x: 0, opacity: 1}, "-=1") // logo
.fromTo(hamburger, 1.0, {x:30, opacity: 0}, {x: 0, opacity: 1}, "-=1") // hamburger
